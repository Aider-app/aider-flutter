...
class RecieverEdit extends StatefulWidget {
  @override
  _RecieverEditState createState() => _RecieverEditState();
}

class _RecieverEditState extends State<RecieverEdit> {
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(
                              ...
                              color: Color(0x802B2D42)),
                          errorText:
                              _validatedescription ? 'Enter Address' : null,
                        ),
                      ),
                    ),
                    SizedBox(width: 50.0),
                ...
                Container(
                  ...
                  child: OutlineButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushReplacement(
                          MaterialPageRoute(
                            builder: (context) => RecipientDetails(),
                          ),
                        );
                      },
                      child: Center(
